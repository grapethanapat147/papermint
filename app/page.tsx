...
export default function StoriesHome() {
  ...
  function addSticker(symbol: string, label: string, x = 50, y = 32) {
    const sticker = { id: makeId(), symbol, label, x, y, size: symbol.length > 3 ? 14 : 26, rotation: Math.round(Math.random() * 12) - 6 };
