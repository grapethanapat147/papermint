import { exportPresets, type ExportPresetId } from "../lib/export";
...
type ShareModalProps = {
  ...
  copyStoryLink: () => void;
  copied: boolean;
  downloadStory: (preset: ExportPresetId) => void;
  /** Drives the privacy note: a photo never travels in the link, only in the PNG. */
  photoData: string | null;
  /** Device handoff: uploads the draft with its photo behind a one-day link. */
  startHandoff: () => void;
